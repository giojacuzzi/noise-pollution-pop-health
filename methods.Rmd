...
### Run BaseOps simulations and generate noise contour maps
...
1.  For a given .baseops file (DNL, LNIGHT, or LEQ24), open it with BaseOps, then select Case \> Run Case
