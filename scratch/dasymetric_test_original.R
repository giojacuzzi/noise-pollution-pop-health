...
library(gdalUtils)
imp_raster_imgfile = '/Users/giojacuzzi/Desktop/PHI Project Data/nlcd_2016_impervious_l48_20210604/nlcd_2016_impervious_l48_20210604.img'
imp_desc_raster_imgfile = '/Users/giojacuzzi/Desktop/PHI Project Data/nlcd_2016_impervious_descriptor_l48_20210604/nlcd_2016_impervious_descriptor_l48_20210604.img'

# Run gdalbuildvrt with all defaults to just create a VRT that points to the IMG without any modification
imp_raster_file <- file.path(direc, 'NLCD_2016_impervious.vrt')
imp_desc_raster_file <- file.path(direc, 'NLCD_2016_impervious_descriptor.vrt')
