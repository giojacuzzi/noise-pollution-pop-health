...
n = 20
data[order(-data$Num.Total)[1:n], c('Num.Total', 'Track.Group', 'Track.Type', 'Track', 'Runway', 'Profile')]
...
df_track = data.frame(
  Track.Group = unlist(labels(ops_per_track_group)),
  Track.Type  = data[match(df_track$Track.Group, data$Track.Group), 'Track.Type'],
