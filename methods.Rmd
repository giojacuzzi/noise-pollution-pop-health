...
3.  Click the `Edit Options` button. From `Option Categories > Contours > Levels`, manually specify contour levels with a lowest primary level (such as 35) and highest 150, with spacing between primary levels of 5, and 0 secondary levels. Click `Apply`.
