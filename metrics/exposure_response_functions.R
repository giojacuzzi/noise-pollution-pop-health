...
ci_FAANES = data=data.frame(
  Ldn  = seq(50, 75),
  Lower= c(15.4,17.5,19.8,22.2,24.9,27.8,30.8,33.9,37.2,40.5,43.8,47.1,50.5,53.7,57.0,60.1,63.1,66.0,68.7,71.3,73.8,76.6,78.8,80.8,82.6,84.3),
  Upper= c(23.4,25.7,28.2,30.9,33.8,36.8,40.0,43.3,46.7,50.2,53.7,57.3,60.8,64.3,67.7,70.9,73.9,76.7,79.4,81.8,84.0,85.6,87.5,89.4,90.8,91.8)
)
