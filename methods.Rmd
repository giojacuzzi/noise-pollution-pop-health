...
-   `NAVY` - The NAVFAC database.
-   `NPS` - Acoustic measurements of EBLA001 and EBLA002 from the National Park Service.
-   `JGL` - Acoustic measurements from JGL Acoustics, Inc. monitoring periods.
...
source('analysis/characterization/preprocessing/calculate_cumulative_metrics.R')
calculate_site_date_metrics_csv()

# Evaluate cumulative metrics
source('analysis/characterization/evaluate_cumulative_metrics.R')
```
...
source('analysis/characterization/preprocessing/calculate_single_event_metrics.R')
...
source('analysis/characterization/evaluate_single_event_metrics.R')
```
