...
# TODO: https://www.noisequest.psu.edu/noiseeffects-speech.html
...
mapview(Ldn_gt55, zcol='Level', layer.name='DNL') + mapview(population_bg, col.regions=list('white')) + mapview(schools, zcol='Ldn55', col.regions=list('gray', 'red'))
